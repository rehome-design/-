    ...
    <div className="flex min-h-screen flex-col">
              ...
              <TabsContent value="case1" className="mt-0">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="flex flex-col">
                        ...
                        <span className="font-medium">わずか8日間で完成</span>
                      </div>
                      <div className="flex flex-col">
                        <span className="text-sm text-muted-foreground">費用</span>
                        <span className="font-medium">ご予算に合わせて最適提案</span>
                      </div>
                    </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-md">
                    <Image
                      src="/placeholder.svg?height=600&width=800"
                      alt="港区のキッチン＆ダイニングリフォーム事例 - 使いやすさと美しさを両立"
                      fill
                      className="object-cover"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-primary">キッチン＆ダイニングリフォーム</h3>
                    <p className="text-muted-foreground mb-4">
                      家族の時間を大切にする対面式キッチンに。収納力も抜群で、料理が楽しくなる空間に生まれ変わりました。
                    </p>
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="flex flex-col">
                        <span className="text-sm text-muted-foreground">工期</span>
                        <span className="font-medium">最短2週間で完成</span>
                      </div>
                      <div className="flex flex-col">
                        <span className="text-sm text-muted-foreground">費用</span>
                        <span className="font-medium">高品質×適正価格</span>
                      </div>
                    </div>
                    <div className="bg-secondary/30 p-4 rounded-lg mb-6 relative">
                      <div className="absolute top-0 left-6 -translate-y-1/2 w-4 h-4 bg-secondary/30 rotate-45"></div>
                      <blockquote className="italic">
                        「毎日の料理が楽しくなりました。家族との会話も増え、リフォームして本当に良かったです。予算内で最高の提案をしていただきました。」
                      </blockquote>
                      <p className="text-right text-sm mt-2 text-muted-foreground">港区 M様</p>
                    </div>
                    <Button className="mt-2 w-fit bg-accent hover:bg-accent/90 text-accent-foreground transition-transform hover:scale-105">
                      詳細を見る <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
              ...
              <TabsContent value="case2" className="mt-0">
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="flex flex-col">
                        <span className="text-sm text-muted-foreground">工期</span>
                        <span className="font-medium">計画的な工程で最短施工</span>
                      </div>
                      <div className="flex flex-col">
                        <span className="text-sm text-muted-foreground">費用</span>
                        <span className="font-medium">補助金活用で負担軽減</span>
                      </div>
                    </div>
                    <div className="bg-secondary/30 p-4 rounded-lg mb-6 relative">
                      <div className="absolute top-0 left-6 -translate-y-1/2 w-4 h-4 bg-secondary/30 rotate-45"></div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-md">
                    <Image
                      src="/placeholder.svg?height=600&width=800"
                      alt="大田区の高齢者向け住宅改修 - 安全で快適な暮らしをサポート"
                      fill
                      className="object-cover"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-primary">高齢者向け住宅改修</h3>
                    <p className="text-muted-foreground mb-4">
                      将来を見据えた安心リフォーム。トイレ・浴室の手すり設置、玄関の段差解消で毎日の生活がラクに。
                    </p>
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="flex flex-col">
                        <span className="text-sm text-muted-foreground">工期</span>
                        <span className="font-medium">生活リズムに合わせた施工</span>
                      </div>
                      <div className="flex flex-col">
                        <span className="text-sm text-muted-foreground">費用</span>
                        <span className="font-medium">介護保険適用で経済的</span>
                      </div>
                    </div>
                    <div className="bg-secondary/30 p-4 rounded-lg mb-6 relative">
                      <div className="absolute top-0 left-6 -translate-y-1/2 w-4 h-4 bg-secondary/30 rotate-45"></div>
                      <blockquote className="italic">
                        「毎日の生活が本当に楽になりました。介護保険の申請手続きまでサポートしていただき、費用面でも助かりました。親切な対応に感謝しています。」
                      </blockquote>
                      <p className="text-right text-sm mt-2 text-muted-foreground">大田区 Y様</p>
                    </div>
                    <Button className="mt-2 w-fit bg-accent hover:bg-accent/90 text-accent-foreground transition-transform hover:scale-105">
                      詳細を見る <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
              ...
              <TabsContent value="case3" className="mt-0">
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <p className="text-muted-foreground mb-4">
                      耐久性と美観を両立した外壁材で、住まいの価値を長持ちさせるリフォーム。断熱性能も大幅アップ。
                    </p>
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="flex flex-col">
                        <span className="text-sm text-muted-foreground">工期</span>
                        <span className="font-medium">天候に配慮した確実施工</span>
                      </div>
                      <div className="flex flex-col">
                        <span className="text-sm text-muted-foreground">費用</span>
                        <span className="font-medium">長期保証付きで安心投資</span>
                      </div>
                    </div>
                    <div className="bg-secondary/30 p-4 rounded-lg mb-6 relative">
                      <div className="absolute top-0 left-6 -translate-y-1/2 w-4 h-4 bg-secondary/30 rotate-45"></div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-primary">屋根・外壁塗装</h3>
                    <p className="text-muted-foreground mb-4">
                      高耐久塗料で美しさと保護性を両立。紫外線や雨風から家を守り、資産価値を維持するリフォーム。
                    </p>
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="flex flex-col">
                        <span className="text-sm text-muted-foreground">工期</span>
                        <span className="font-medium">丁寧な下地処理で長持ち</span>
                      </div>
                      <div className="flex flex-col">
                        <span className="text-sm text-muted-foreground">費用</span>
                        <span className="font-medium">分割払いで無理なく実現</span>
                      </div>
                    </div>
                    <div className="bg-secondary/30 p-4 rounded-lg mb-6 relative">
                      <div className="absolute top-0 left-6 -translate-y-1/2 w-4 h-4 bg-secondary/30 rotate-45"></div>
                      <blockquote className="italic">
                        「近所の方からも『家が新しくなったね』と言われて嬉しいです。塗料の種類や色を細かく提案していただき、イメージ通りの仕上がりになりました。」
                      </blockquote>
                      <p className="text-right text-sm mt-2 text-muted-foreground">品川区 N様</p>
                    </div>
                    <Button className="mt-2 w-fit bg-accent hover:bg-accent/90 text-accent-foreground transition-transform hover:scale-105">
                      詳細を見る <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
        ...
        <section className="py-16 md:py-24 flex items-center">
          <div className="container">
              ...
              <table className="w-full border-collapse bg-background rounded-lg shadow-sm">
                ...
                <tbody>
                  <tr className="border-b border-border/40">
                    ...
                    <td className="p-4">5日〜7日</td>
                    <td className="p-4">断熱・保温性能向上、節水設計、大田区・品川区で人気</td>
                  </tr>
                  <tr className="border-b border-border/40 bg-muted/30">
                    <td className="p-4 font-medium">キッチンリフォーム</td>
                    <td className="p-4">60万円〜180万円</td>
                    <td className="p-4">7日〜14日</td>
                    <td className="p-4">収納力アップ、IH対応可、品川区で評判の高いデザイン</td>
                  </tr>
                  <tr className="border-b border-border/40">
                    <td className="p-4 font-medium">トイレ交換</td>
                    <td className="p-4">20万円〜45万円</td>
                    <td className="p-4">1〜2日</td>
                    <td className="p-4">節水型、自動洗浄機能、港区で口コミ多数</td>
                  </tr>
                  <tr className="border-b border-border/40 bg-muted/30">
                    <td className="p-4 font-medium">給湯器交換</td>
                    <td className="p-4">15万円〜35万円</td>
                    <td className="p-4">半日〜1日</td>
                    <td className="p-4">エコジョーズ対応、省エネ設計、補助金申請サポート</td>
                  </tr>
                  <tr className="border-b border-border/40">
                    <td className="p-4 font-medium">クロス貼替（6畳間）</td>
                    <td className="p-4">5万円〜12万円</td>
                    <td className="p-4">1〜2日</td>
                    <td className="p-4">消臭・抗菌機能付き素材あり、目黒区で安い価格設定</td>
                  </tr>
                  <tr className="border-b border-border/40 bg-muted/30">
                    <td className="p-4 font-medium">フローリング張替（6畳間）</td>
                    <td className="p-4">12万円〜25万円</td>
                    <td className="p-4">2〜3日</td>
                    <td className="p-4">防音・耐久性向上、ペット対応素材あり、大田区で実績多数</td>
                  </tr>
                  <tr className="border-b border-border/40">
                    <td className="p-4 font-medium">洗面台交換</td>
                    <td className="p-4">15万円〜40万円</td>
                    <td className="p-4">1〜2日</td>
                    <td className="p-4">収納力アップ、LED照明付き、品川区で人気のデザイン</td>
                  </tr>
                  <tr className="border-b border-border/40 bg-muted/30">
                    <td className="p-4 font-medium">外壁塗装（戸建て）</td>
                    <td className="p-4">80万円〜180万円</td>
                    <td className="p-4">7〜14日</td>
                    <td className="p-4">高耐久塗料使用、10年保証付き、目黒区で評判の仕上がり</td>
                  </tr>
                  <tr className="border-b border-border/40">
                    <td className="p-4 font-medium">屋根修繕・葺き替え</td>
                    <td className="p-4">60万円〜150万円</td>
                    <td className="p-4">3〜7日</td>
                    <td className="p-4">防水性能向上、台風対策、港区で信頼の施工実績</td>
                  </tr>
                  <tr>
                    <td className="p-4 font-medium">間取り変更リノベーション</td>
                    <td className="p-4">200万円〜500万円</td>
                    <td className="p-4">30〜60日</td>
                    <td className="p-4">ライフスタイル対応設計、3Dシミュレーション、大田区で好評</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <p className="text-sm text-muted-foreground text-center mt-4">
              ...
              <br />
              ※2024年4月現在のデータに基づく価格設定です。材料費の変動により若干の変更がある場合がございます。
            </p>
              ...
              <Accordion type="single" collapsible className="w-full">
                ...
                <AccordionItem value="item-6" className="border-b border-border/40">
                  <AccordionTrigger className="text-left font-medium py-4 hover:text-primary">
                    <div className="flex items-start gap-3">
                      <HelpCircle className="h-5 w-5 text-accent mt-0.5 flex-shrink-0" />
                      <span>マンションのリフォームは可能ですか？制限はありますか？</span>
                    </div>
                  </AccordionTrigger>
                  <AccordionContent className="pl-8 text-muted-foreground">
                    <p>
                      はい、マンションのリフォームも多数承っております。ただし、マンションの場合は管理規約や構造上の制約があるため、事前に管理組合への確認が必要です。当社では管理組合への申請手続きのサポートも行っており、構造に影響を与えない範囲で最大限お客様のご要望に沿ったプランをご提案いたします。特に水回りのリフォームや内装の変更は、多くのマンションで可能です。港区・品川区のマンションリフォーム実績も豊富にございます。
                    </p>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-7" className="border-b border-border/40">
                  <AccordionTrigger className="text-left font-medium py-4 hover:text-primary">
                    <div className="flex items-start gap-3">
                      <HelpCircle className="h-5 w-5 text-accent mt-0.5 flex-shrink-0" />
                      <span>リフォーム費用の支払い方法は？分割払いは可能ですか？</span>
                    </div>
                  </AccordionTrigger>
                  <AccordionContent className="pl-8 text-muted-foreground">
                    <p>
                      お支払い方法は、現金一括払いの他、クレジットカード決済、リフォームローン、住宅ローンの追加融資など様々な方法に対応しております。分割払いについても、提携金融機関のリフォームローンをご利用いただけます。最長15年の長期返済プランもあり、月々の負担を抑えながら理想のリフォームを実現できます。また、工事内容によっては着手金・中間金・完成金の分割でのお支払いも可能です。お客様のご状況に合わせた最適なプランをご提案いたします。
                    </p>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-8" className="border-b border-border/40">
                  <AccordionTrigger className="text-left font-medium py-4 hover:text-primary">
                    <div className="flex items-start gap-3">
                      <HelpCircle className="h-5 w-5 text-accent mt-0.5 flex-shrink-0" />
                      <span>リフォーム後のメンテナンスはどうなりますか？</span>
                    </div>
                  </AccordionTrigger>
                  <AccordionContent className="pl-8 text-muted-foreground">
                    <p>
                      当社では、リフォーム完了後も安心してお住まいいただけるよう、定期的なアフターメンテナンスを実施しています。工事完了後1ヶ月、6ヶ月、1年後に無料点検を行い、必要に応じて調整や補修を行います。また、24時間対応の緊急サポート窓口も設けており、突発的なトラブルにも迅速に対応いたします。さらに、有料のメンテナンスプランもご用意しており、長期にわたって住まいの美しさと機能性を維持するサポートを行っています。自社施工だからこそできる、責任を持ったアフターフォローが当社の強みです。
                    </p>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-9" className="border-b border-border/40">
                  <AccordionTrigger className="text-left font-medium py-4 hover:text-primary">
                    <div className="flex items-start gap-3">
                      <HelpCircle className="h-5 w-5 text-accent mt-0.5 flex-shrink-0" />
                      <span>リフォームの相談から完成までどのくらいの期間がかかりますか？</span>
                    </div>
                  </AccordionTrigger>
                  <AccordionContent className="pl-8 text-muted-foreground">
                    <p>
                      リフォームの規模や内容によって異なりますが、一般的な流れとしては、初回相談から現地調査、プラン・お見積り提案、契約、着工、完成までの期間は、小規模なリフォームであれば1〜2ヶ月程度、キッチンやバスなどの水回りリフォームで2〜3ヶ月程度、全面リフォームの場合は3〜6ヶ月程度が目安となります。当社では、お客様のご要望に合わせて最適な工程計画を立て、効率的な施工を心がけています。また、急ぎのリフォームにも可能な限り対応しておりますので、お気軽にご相談ください。
                    </p>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-10" className="border-b border-border/40">
                  <AccordionTrigger className="text-left font-medium py-4 hover:text-primary">
                    <div className="flex items-start gap-3">
                      <HelpCircle className="h-5 w-5 text-accent mt-0.5 flex-shrink-0" />
                      <span>エコ素材や省エネ設備について詳しく知りたいです</span>
                    </div>
                  </AccordionTrigger>
                  <AccordionContent className="pl-8 text-muted-foreground">
                    <p>
                      当社では、環境に配慮したエコ素材や省エネ設備を積極的に採用しています。断熱性能の高い窓サッシや断熱材、自然素材の珪藻土や無垢材、VOC（揮発性有機化合物）を含まない塗料など、健康と環境に配慮した素材を多数取り扱っています。また、省エネ効果の高い給湯器やLED照明、太陽光発電システムなどの導入もサポートしています。これらの設備は初期費用はかかりますが、長期的には光熱費の削減につながり、経済的にもメリットがあります。さらに、各種補助金制度も活用できるため、トータルコストを抑えながら環境に優しい住まいづくりが可能です。詳しくはショールームでの相談会も定期的に開催していますので、ぜひご参加ください。
                    </p>
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse bg-background rounded-lg shadow-sm">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-border/40 bg-muted/30">
                      <td className="p-4 font-medium">営業事務</td>
                      <td className="p-4">見積書作成・契約書管理・顧客対応</td>
                      <td className="p-4">細部への配慮×マルチタスク処理能力</td>
                    </tr>
                    <tr className="border-b border-border/40">
                      <td className="p-4 font-medium">経理</td>
                      <td className="p-4">会計処理・予算管理・経費精算</td>
                      <td className="p-4">正確性×業務効率化の提案力</td>
                    </tr>
                    <tr className="border-b border-border/40 bg-muted/30">
                      <td className="p-4 font-medium">現場施工職</td>
                      <td className="p-4">内装工事・設備取付・品質管理</td>
                      <td className="p-4">技術力×丁寧な仕事への誇り</td>
                    </tr>
                    <tr>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                <form className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="reservation-type" className="text-sm font-medium">
                      ご予約タイプ
                    </label>
                    <select
                      id="reservation-type"
                    ...
                    >
                      ...
                      <option value="site-visit">現地調査</option>
                      <option value="showroom">ショールーム見学</option>
                    </select>
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <option value="evening">夕方以降（17:00〜19:00）</option>
                    </select>
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">〒144-0033 東京都大田区東糀谷3-5-6・1階</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">03-6339-1816</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">info@hotta-haru.com</p>
                    </div>
                  </div>
                </div>
                <div className="mt-8">
      ...
      <section className="py-16 md:py-20 bg-secondary/20">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold tracking-tight md:text-4xl mb-4 text-primary">
              代表者<span className="text-accent">プロフィール</span>
            </h2>
            <p className="text-lg text-muted-foreground">お客様の理想の住まいづくりを全力でサポートいたします</p>
          </div>

          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative aspect-[3/4] md:aspect-square rounded-lg overflow-hidden shadow-lg">
              <Image
                src="/placeholder.svg?height=600&width=600"
                alt="Re:Home Design 代表取締役 堀田 晴彦"
                fill
                className="object-cover"
              />
            </div>
            <div className="space-y-6">
              <div>
                <h3 className="text-2xl font-bold text-primary mb-1">Re:HomeDesign　株式会社HOTTA</h3>
                <p className="text-accent font-medium">代表取締役　堀田　はるき</p>
              </div>

              <div className="space-y-4 text-muted-foreground">
                <p className="font-medium text-primary">「住まいが変わると、人生も変わる。」</p>
                <p>
                  子どもの頃から、街が変わっていく様子を見ながら、
                  「いつか自分の手で、人が笑顔になれる空間をつくりたい」と思うようになりました。
                  10代で建設業界に飛び込み、現場やメンテナンス業務を通して "暮らしを支える仕事"の喜びを学びました。
                </p>
                <p>
                  20代は営業職や管理職を経験。24歳ではインテリア雑貨の販売事業での起業、
                  初めての起業。しかし、勢いだけでは難しく、思い通りにはいきませんでした。
                  そこから内装施工職人として再び現場へ。4年半、技術と向き合い、29歳でゼロから再スタート。
                </p>
                <p>
                  仲間を増やしながら少しずつ成長し、数多くの試練もありましたが、
                  若手や未経験の女性スタッフも加わり、今では多様性とあたたかさに満ちた"人でつながるチーム"ができました。
                </p>
                <p className="font-medium text-primary">「すべては世のため人のために」</p>
                <p>
                  私たちが手がけるリフォームは、ただの工事ではありません。
                  感謝される仕事、笑顔をつくる仕事、感動を届ける仕事――それが、私たちの誇りです。
      ...
      <footer className="bg-background border-t">
        <div className="container py-12 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-center md:text-right">
            ...
            <p className="text-xs text-muted-foreground">東京都大田区東糀谷3-5-6・1階 | 03-6339-1816</p>
          </div>
        </div>
      </footer>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4">
        <a
          ...
          className="bg-[#06C755] hover:bg-[#05B54A] text-white rounded-full p-3 shadow-lg flex items-center transition-transform hover:scale-105"
        >
          <MessageSquareText className="h-6 w-6 mr-2" />
          <span className="font-medium">LINE予約</span>
        </a>
        <a
          href="#contact"
          onClick={(e) => {
          ...
          className="bg-accent hover:bg-accent/90 text-accent-foreground rounded-full p-3 shadow-lg flex items-center transition-transform hover:scale-105"
        >
